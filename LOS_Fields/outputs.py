...
def plot5(num_sightlines):
	rescale_Z(0.5)
	midpoint1s, dN_by_dX1s = cumulative_EW(num_sightlines, False, incomplete = True, cumulative = False)
	...
	rescale_Ga_12(0.1)
	midpoint2s, dN_by_dX2s = cumulative_EW(num_sightlines, False, incomplete = True, cumulative = False)
	...
	rescale_Ga_12(100.0)
	midpoint3s, dN_by_dX3s = cumulative_EW(num_sightlines, False, incomplete = True, cumulative = False)
